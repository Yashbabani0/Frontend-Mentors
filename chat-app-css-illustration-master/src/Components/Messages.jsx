...
export default function Messages() {
  return (
    <div className="h-[30em] bg-transparent p-[1em] flex flex-col gap-[0.7em] text-[0.7em]">
      <div className="w-[50%] md:w-[60%] bg-pale-violet bg-opacity-70 text-moderate-violet font-medium tracking-wide p-[0.5em] px-[1em] rounded-t-[1em] rounded-br-[1em] rounded-bl-[0.5em]">
        That sounds great. I’d be happy with that.
      </div>
      <div className="w-[55%] md:w-[80%] bg-pale-violet bg-opacity-70 text-moderate-violet font-medium tracking-wide p-[0.5em] px-[1em] rounded-t-[1em] rounded-br-[1em] rounded-bl-[0.5em]">
      ...
      <div className="flex items-center w-[70%] rounded-t-[1em] rounded-bl-[1em] rounded-br-[0.5em] text-desaturated-dark-violet border self-end text-[0.9em] bg-white py-[1em] px-[1em]">
        Here are a few pictures. She’s a happy girl!
      </div>
      <div className="flex items-center w-[45%] rounded-t-[1em] rounded-bl-[1em] rounded-br-[0.5em] text-desaturated-dark-violet border self-end text-[0.9em] bg-white py-[1em] px-[1em]">
        Can you make it?
      </div>
      ...
      <div className="flex justify-between items-center bg-white rounded-full mt-[1em] h-[5em]">
        <div className="text-desaturated-dark-violet pl-[1em]">
          Type a message…
        </div>
